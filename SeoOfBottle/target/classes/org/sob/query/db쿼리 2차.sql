...
CREATE TABLE IF NOT EXISTS `boast` (
  ...
  CONSTRAINT `FK_boast_bottlemain` FOREIGN KEY (`groupid`) REFERENCES `bottlemain` (`groupid`)
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='기본적인 rwud 테이블';
