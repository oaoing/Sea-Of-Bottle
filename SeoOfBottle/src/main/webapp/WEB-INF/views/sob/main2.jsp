		...
		<div class="row">
			<div class="col-lg-8">
				<div class="blog_left_sidebar">
					...
					<c:forEach items="${list2}" var="test">
						...
						<ul class="pagination">
							<c:if test="${pageMaker.prev }">
								<li class="page-item"><a
									href="main2?pageNum=${pageMaker.startPage-1}&amount=${pageMaker.cri.amount}&categoryid=${pageMaker.cri.categoryid }"
							...
							<c:forEach begin="${pageMaker.startPage }"
								...
								<c:if test="${pageMaker.cri.pageNum == num }">
									<li class="page-item active"><a
										href="main2?pageNum=${num}&amount=${pageMaker.cri.amount}&categoryid=${pageMaker.cri.categoryid }"
							...
							<c:if test="${pageMaker.next }">
								<li class="page-item"><a
									href="main2?pageNum=${pageMaker.endPage+1}&amount=${pageMaker.cri.amount}"
